...
namespace CarSalesStaticMethods
{
    class Program
    {
        ...
        class Car
        {
            ...
            // we will create a AddCar method to add the car details
        ...
        static void Main(string[] args)
        {
            ...
            Car car1 = new Car();//car1 object is created
            car1.AddCar("RollsRoyce", "Silver Cloud", 35000);// Now calling AddCar method and just passing vehicle details
