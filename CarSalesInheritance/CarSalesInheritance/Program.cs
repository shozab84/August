...
namespace CarSalesStaticMethods
{
    class Program
    {
        ...
        // Here we are creating a Vehicle class from which - Car and Motorcycle classes will inherit
        class Vehicle
        {
            public string make;
            public string model;
            ...
            class Car : Vehicle //Car class inheriting from base vehicle class
            {
                public string type;
                public static int numberOfCars;
            ...
            class Motorcycle : Vehicle // Motorcycle class inheriting from base Vehicle class
            {
                public string type;
